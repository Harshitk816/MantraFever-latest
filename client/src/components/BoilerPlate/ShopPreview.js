...
export default function ShopPreview() {
    return (
        <div>
            <section class="text-midnight body-font">
        <div class="container px-5 py-24 mx-auto">
            <div class="text-center mb-20">
            <h1 class="sm:text-3xl text-2xl font-medium text-center title-font text-midnight mb-4">Find The Best Outfit for You</h1>
